...
const MessagesList = (props) => {
  ...
  useEffect(() => { // permet de gerer le chargement du composant ou 
    setMessagesListState(store.getState().tchat.messages); // init pour recuperer les donnée avant le init du composant
    setUsersListState(store.getState().tchat.users); // init pour recuperer les donnée avant le init du composant
    store.subscribe(() => {
